...
class VQA_header(nn.Module):
    ...
    def __init__(self,args, ans_vocab_type_dict):
        super().__init__()
...
class HieVQA(nn.Module):
    ...
    def __init__(self, args, question_vocab_size, ans_vocab_type_dict):
        ...
        # self.question_relevance_mlp = QR_header(args)
        self.questiont_type_mlp = QuestionType(args)
        self.Ques_Ans_Attention = Ques_Ans_Attention(self.args, args.model_config["image_feature_output"], 512)
        # self.loss_weights = args.model_config["loss_weight"]
    ...
    def forward(self, image, question, train=True):
        ...
        self.debug_print("\nQuestion-guided Attention")
        attended_features = self.Ques_Ans_Attention(image, question)
